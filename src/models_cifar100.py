...
def get_resnet18(num_classes: int = 100, pretrained: bool = False) -> nn.Module:
    """
    ...
    return model
    '''
    # Updated from None to  weights=models.ResNet18_Weights.DEFAULT
...
if __name__ == "__main__":
    ...
    model_s = SmallCNN(num_classes=100).to(device)
    ...
    print(f"MS output shape : {out_s.shape}")   # → (4, 100)
    print(f"ML output shape : {out_l.shape}")   # → (4, 100)
