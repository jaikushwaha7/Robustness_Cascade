...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate the cascade and optionally log results to Weights & Biases.")
    ...
    if wandb_run is not None:
        ...
        wandb_run.summary["eval/result_file"] = "eval_results.pkl"
